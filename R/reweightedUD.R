########################################################################################
## Rebalancer des kernels qui s'additionne en de?a de "1"
# out=1 retourne probabilités originales (redistribu?es)
# out=2 retourne volumes (redistribu?s)
...
#'
#' @examples
reweightedUD <- function(UD, out=1) {
